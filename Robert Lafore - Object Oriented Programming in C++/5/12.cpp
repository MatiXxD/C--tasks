...
Fraction fadd(const Fraction& frac1, const Fraction& frac2);
Fraction fsub(const Fraction& frac1, const Fraction& frac2);
Fraction fmlt(const Fraction& frac1, const Fraction& frac2);
Fraction fdiv(const Fraction& frac1, const Fraction& frac2);
