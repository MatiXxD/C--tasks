...
istream& operator >> (istream& s, Fraction& frac) {
	...
	while (frac.denominator == 0 || !s.good()) {
		s.clear(); s.ignore(1024, '\n');
		std::cout << "Wrong fraction. Enter fraction again: ";
		s >> frac.numerator >> trash >> frac.denominator;
	}
...
int main() {
	...
	std::cout << "Enter first fraction: "; cin >> frac1;
	std::cout << "Enter operation: "; cin >> operation;
	std::cout << "Enter second fraction: "; cin >> frac2;
